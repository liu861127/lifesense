...
namespace lifesense.DAL
{
	...
	public partial class t_sleepinfo
	{
		...
		public int Add(lifesense.Model.t_sleepinfo model)
		{
			...
			strSql.Append("SleepingTime,WakingTime,LongSleepNum,ShallowSleepNum,WakeUpLong,WakingNum)");
			...
			parameters[0].Value = model.SleepingTime;
			parameters[1].Value = model.WakingTime;
			parameters[2].Value = model.LongSleepNum;
			parameters[3].Value = model.ShallowSleepNum;
			parameters[4].Value = model.WakeUpLong;
			parameters[5].Value = model.WakingNum;
		...
		public lifesense.Model.t_sleepinfo GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,SleepingTime,WakingTime,LongSleepNum,ShallowSleepNum,WakeUpLong,WakingNum from t_sleepinfo ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,SleepingTime,WakingTime,LongSleepNum,ShallowSleepNum,WakeUpLong,WakingNum ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,SleepingTime,WakingTime,LongSleepNum,ShallowSleepNum,WakeUpLong,WakingNum ");
			strSql.Append(" FROM t_sleepinfo ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
